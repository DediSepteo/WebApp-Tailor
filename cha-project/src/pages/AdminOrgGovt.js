...
const AdminPage = () => {
    ...
    const [orgGovtData, setOrgGovtData] = useState([])
    ...
    const getAll = async () => {
        try {
            fetch('http://localhost:3000/api/org/govt')
    ...
    return (
        <main style={{ display: 'flex', flexDirection: "row", backgroundColor: "#F1F2F7" }}>
            ...
            <div className={styles.container}>
                <AdminNavBar pageName="Manage Organizations (Government)" />
                ...
                <div className={styles.management}>
                    <div className={styles.manageDiv}>
                        ...
                        <ul>
                            ...
                            <li className={styles.li}><NavLink className={styles.link} to="/admin/government/orgs/register">Register New Organization</NavLink></li>
